...
class CommentBox
  ...
  # once we have things up and displayed, let's start polling for updates
  ...
  # finally our component should be a good citizen and stop the polling when it's unmounted
  ...
  # A very common mistake is to try to generate two or more elements (or none at all). Either case will
...
class CommentForm
  ...
  def render
    div do
      ...
      # Finally let's give the use a button to submit changes.  Why not? We have come this far!
...
class Showdown
  ...
  def render
    ...
    # React.js takes a very dim view of passing raw html so it's purposefully made
